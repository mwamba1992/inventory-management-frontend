  ...
  <div class="min-h-screen bg-neutral-50 p-4">
    <div class="max-w-full mx-auto">
      ...
      <div class="flex items-center text-sm text-neutral-500 mb-6">
        ...
        <span>Inventory</span>
        <ChevronRightIcon class="w-4 h-4 mx-2" />
        <span class="text-neutral-700 font-medium">Warehouses</span>
      </div>
      ...
      <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-soft border border-white/20 mb-8">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between p-6">
          <div>
            ...
            <p class="text-neutral-600 mt-2">Manage your warehouse locations and storage facilities</p>
          </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        >
          <div class="flex items-center justify-between">
            <div>
              <p class="text-sm font-medium text-neutral-600">Total Warehouses</p>
              <p class="text-2xl font-bold text-neutral-900">{{ warehouses.length }}</p>
            </div>
            <div class="p-3 bg-brand-100 rounded-xl">
              <BuildingOffice2Icon class="w-6 h-6 text-brand-600" />
            </div>
          </div>
        </div>
        ...
        >
          <div class="flex items-center justify-between">
            <div>
              <p class="text-sm font-medium text-neutral-600">Active Warehouses</p>
              <p class="text-2xl font-bold text-neutral-900">{{ activeWarehouses }}</p>
            </div>
        ...
        >
          <div class="flex items-center justify-between">
            <div>
              <p class="text-sm font-medium text-neutral-600">Total Capacity</p>
              <p class="text-2xl font-bold text-neutral-900">{{ totalCapacity.toLocaleString() }}</p>
              <p class="text-xs text-neutral-500">sq ft</p>
            </div>
        ...
        >
          <div class="flex items-center justify-between">
            <div>
              <p class="text-sm font-medium text-neutral-600">Avg Capacity</p>
              <p class="text-2xl font-bold text-neutral-900">{{ averageCapacity.toLocaleString() }}</p>
              <p class="text-xs text-neutral-500">sq ft</p>
            </div>
        ...
        <div class="overflow-x-auto">
          <table class="w-full">
            ...
            <tr>
              ...
              >
                <div class="flex items-center justify-between">
                  <span class="text-sm font-semibold text-neutral-900">Warehouse Name</span>
                  <ArrowsUpDownIcon class="w-4 h-4 text-neutral-400" />
                </div>
              </th>
              <th
              ...
              >
                <div class="flex items-center justify-between">
                  <span class="text-sm font-semibold text-neutral-900">Capacity</span>
                  <ArrowsUpDownIcon class="w-4 h-4 text-neutral-400" />
                </div>
              </th>
              <th
            ...
            <tr v-if="loading">
              <td colspan="7" class="p-12 text-center">
                <div class="flex items-center justify-center space-x-3">
                  ...
                  <span class="text-neutral-500">Loading warehouses...</span>
                </div>
              </td>
            </tr>
            <tr v-else-if="paginatedWarehouses.length === 0">
              <td colspan="7" class="p-12 text-center text-neutral-500">
                <BuildingOffice2Icon class="w-12 h-12 mx-auto text-neutral-300 mb-4" />
            ...
            >
              ...
              <td class="p-4">
                <span class="text-sm font-medium text-neutral-900">#{{ warehouse.id }}</span>
              </td>
              <td class="p-4">
                <div class="flex items-center space-x-3">
                  <div
                    class="w-10 h-10 bg-gradient-to-br from-brand-500 to-purple-600 rounded-xl flex items-center justify-center"
                  >
                  ...
                  <div>
                    <p class="text-sm font-medium text-neutral-900">{{ warehouse.name }}</p>
                    <p v-if="warehouse.code" class="text-xs text-neutral-500">
                      Code: {{ warehouse.code }}
                    </p>
                  </div>
                </div>
              ...
              <td class="p-4">
                <div>
                  <p class="text-sm text-neutral-900">{{ warehouse.address }}</p>
                  <p class="text-xs text-neutral-500">{{ warehouse.city }}, {{ warehouse.country }}</p>
                </div>
              </td>
              <td class="p-4">
                <div>
        ...
        <div class="bg-white rounded-2xl shadow-soft-lg w-full max-w-4xl max-h-[90vh] overflow-y-auto">
          ...
          <form @submit.prevent="saveWarehouse" class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label class="block text-sm font-semibold text-neutral-700 mb-2">Warehouse Name *</label>
                <input
                  v-model="form.name"
                  type="text"
                  required
              ...
              <div>
                <label class="block text-sm font-semibold text-neutral-700 mb-2">Code</label>
                <input
                  v-model="form.code"
                  type="text"
              ...
              <div>
                <label class="block text-sm font-semibold text-neutral-700 mb-2">State/Province</label>
                <input
                  v-model="form.state"
                  type="text"
                  class="w-full border border-neutral-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-brand-500 focus:border-transparent transition-all duration-200"
              ...
              <div>
                <label class="block text-sm font-semibold text-neutral-700 mb-2">Postal Code</label>
                <input
              ...
              <div>
                <label class="block text-sm font-semibold text-neutral-700 mb-2">Capacity (sq ft) *</label>
                <input
              ...
              <div>
                <label class="block text-sm font-semibold text-neutral-700 mb-2">Warehouse Type</label>
                <select
                  v-model="form.type"
                  class="w-full border border-neutral-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-brand-500 focus:border-transparent transition-all duration-200"
                >
              ...
              <div>
                <label class="block text-sm font-semibold text-neutral-700 mb-2">Manager Name</label>
                <input
        ...
        <div class="bg-white rounded-2xl shadow-soft-lg w-full max-w-md">
          <div class="p-6">
            <div class="flex items-center mb-4">
              ...
              <h3 class="text-lg font-bold text-neutral-900">Delete Warehouse</h3>
            </div>
