      ...
      <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 mb-8">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between p-6">
          <div>
            ...
            <p class="text-gray-600 mt-2">Manage product brands and manufacturers</p>
          </div>
            ...
            <tbody class="divide-y divide-gray-200/50">
              ...
              <tr v-else-if="paginatedBrands.length === 0">
                <td colspan="7" class="p-12 text-center text-gray-500">
                  <BuildingStorefrontIcon class="w-12 h-12 mx-auto text-gray-300 mb-4" />
              ...
              >
                ...
                <td class="p-4">
                  <div class="flex items-center space-x-3">
                    ...
                    <div
                      v-else
                      class="w-10 h-10 rounded-lg border border-gray-200 bg-gray-100 flex items-center justify-center"
                    >
                      <BuildingStorefrontIcon class="w-5 h-5 text-gray-400" />
                    </div>
                    <div>
                      <p class="text-sm font-medium text-gray-900">{{ brand.name }}</p>
                      <p class="text-xs text-gray-500">Brand #{{ brand.id }}</p>
                    </div>
                  </div>
                </td>
                <td class="p-4">
        ...
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
          ...
          <form @submit.prevent="saveBrand" class="p-6">
            <div class="grid grid-cols-1 gap-6">
              ...
              <div
                v-if="form.name"
                class="bg-gradient-to-br from-gray-50 to-blue-50 rounded-xl p-6 border border-gray-200 shadow-sm"
              >
                ...
                <div class="flex items-center space-x-4">
                  <div
                    v-if="form.logoUrl"
                    class="w-20 h-20 rounded-xl border-2 border-white shadow-lg overflow-hidden"
                  >
                    <img
                      :src="form.logoUrl"
                      :alt="form.name"
                  ...
                  <div
                    v-else
                    class="w-20 h-20 rounded-xl border-2 border-white shadow-lg bg-gray-100 flex items-center justify-center"
                  >
                    <BuildingStorefrontIcon class="w-10 h-10 text-gray-400" />
                  </div>
                  <div class="flex-1">
