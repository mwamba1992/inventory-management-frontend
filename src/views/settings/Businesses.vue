  ...
  <div class="min-h-screen bg-neutral-50 p-4">
    <div class="max-w-full mx-auto">
      ...
      <div class="flex items-center text-sm text-neutral-500 mb-6">
        ...
        <span>Settings</span>
        <ChevronRightIcon class="w-4 h-4 mx-2" />
        <span class="text-neutral-700 font-medium">Business Management</span>
      </div>
      ...
      <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-soft border border-white/20 mb-8">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between p-6">
          <div>
            ...
            <p class="text-neutral-600 mt-2">Manage your business profiles and information</p>
          </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        >
          <div class="flex items-center justify-between">
            <div>
              <p class="text-sm font-medium text-neutral-600">Total Businesses</p>
              <p class="text-2xl font-bold text-neutral-900">{{ businesses.length }}</p>
            </div>
            <div class="p-3 bg-brand-100 rounded-xl">
              <BuildingOfficeIcon class="w-6 h-6 text-brand-600" />
            </div>
          </div>
        </div>
        ...
        >
          <div class="flex items-center justify-between">
            <div>
              <p class="text-sm font-medium text-neutral-600">With Website</p>
              <p class="text-2xl font-bold text-neutral-900">{{ businessesWithWebsite }}</p>
            </div>
        ...
        >
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-2xl font-bold text-neutral-900">{{ businessesWithEmail }}</p>
            </div>
          ...
          <table class="w-full">
            <thead class="bg-neutral-50/50">
              <tr>
                ...
                >
                  <div class="flex items-center justify-between">
                    <span class="text-sm font-semibold text-neutral-900">Business Name</span>
                    <ArrowsUpDownIcon class="w-4 h-4 text-neutral-400" />
                  </div>
                </th>
                <th class="p-4 text-left">
                ...
                <th class="p-4 text-left">
                  <span class="text-sm font-semibold text-neutral-900">Items Count</span>
                </th>
                <th class="p-4 text-left">
            ...
            <tbody class="divide-y divide-neutral-200/50">
              <tr v-if="loading">
                <td colspan="6" class="p-12 text-center">
                  <div class="flex items-center justify-center space-x-3">
                    ...
                    <span class="text-neutral-500">Loading businesses...</span>
                  </div>
                </td>
              </tr>
              <tr v-else-if="paginatedBusinesses.length === 0">
                <td colspan="6" class="p-12 text-center text-neutral-500">
                  <BuildingOfficeIcon class="w-12 h-12 mx-auto text-neutral-300 mb-4" />
              ...
              >
                ...
                <td class="p-4">
                  <span class="text-sm font-medium text-neutral-900">#{{ business.id }}</span>
                </td>
                <td class="p-4">
                  <div class="flex items-center space-x-3">
                    <div
                    ...
                    <div>
                      <p class="text-sm font-medium text-neutral-900">{{ business.name }}</p>
                      <p class="text-xs text-neutral-500 max-w-xs truncate">
                ...
                <td class="p-4">
                  <div class="space-y-1">
                    <p v-if="business.email" class="text-xs text-neutral-600 flex items-center">
                      <EnvelopeIcon class="w-3 h-3 mr-1" />
                      {{ business.email }}
                    </p>
                    <p v-if="business.phone" class="text-xs text-neutral-600 flex items-center">
                      <PhoneIcon class="w-3 h-3 mr-1" />
                      {{ business.phone }}
                    </p>
                    <p v-if="!business.email && !business.phone" class="text-xs text-neutral-400">
                      No contact info
                    </p>
                  </div>
                </td>
                <td class="p-4">
                  ...
                  <span v-else class="text-xs text-neutral-400">No website</span>
                </td>
                <td class="p-4">
              ...
              <div>
                ...
                <div class="relative">
                  ...
                  <input
                    v-model="form.email"
                    type="email"
                    class="w-full border border-neutral-300 rounded-xl pl-10 pr-4 py-3 focus:ring-2 focus:ring-brand-500 focus:border-transparent transition-all duration-200"
        ...
        <div class="bg-white rounded-2xl shadow-soft-lg w-full max-w-md">
          <div class="p-6">
            <div class="flex items-center mb-4">
              ...
              <h3 class="text-lg font-bold text-neutral-900">Delete Business</h3>
            </div>
