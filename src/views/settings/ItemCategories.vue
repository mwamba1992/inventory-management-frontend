  ...
  <div class="min-h-screen bg-neutral-50 p-4">
    <div class="max-w-full mx-auto">
      ...
      <div class="flex items-center text-sm text-neutral-500 mb-6">
        ...
        <span>Items</span>
        <ChevronRightIcon class="w-4 h-4 mx-2" />
        <span class="text-neutral-700 font-medium">Categories</span>
      </div>
      ...
      <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-soft border border-white/20 mb-8">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between p-6">
          <div>
            ...
            <p class="text-neutral-600 mt-2">Organize and manage your product categories</p>
          </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        >
          <div class="flex items-center justify-between">
            <div>
              <p class="text-sm font-medium text-neutral-600">Total Categories</p>
              <p class="text-2xl font-bold text-neutral-900">{{ categories.length }}</p>
            </div>
        ...
        >
          <div class="flex items-center justify-between">
            <div>
              <p class="text-sm font-medium text-neutral-600">Active Categories</p>
              <p class="text-2xl font-bold text-neutral-900">{{ activeCategories }}</p>
            </div>
        ...
        >
          <div class="flex items-center justify-between">
            <div>
              <p class="text-sm font-medium text-neutral-600">Parent Categories</p>
              <p class="text-2xl font-bold text-neutral-900">{{ parentCategories }}</p>
            </div>
        ...
        <div class="overflow-x-auto">
          <table class="w-full">
            ...
            <tr>
              ...
              >
                <div class="flex items-center justify-between">
                  <span class="text-sm font-semibold text-neutral-900"># Items</span>
                  <ArrowsUpDownIcon class="w-4 h-4 text-neutral-400" />
                </div>
              </th>
              <th class="p-4 text-left">
            ...
            <tr v-else-if="paginatedCategories.length === 0">
              <td colspan="7" class="p-12 text-center text-neutral-500">
                <FolderIcon class="w-12 h-12 mx-auto text-neutral-300 mb-4" />
            ...
            >
              ...
              <td class="p-4">
                <span class="text-sm font-medium text-neutral-900">#{{ category.id }}</span>
              </td>
              <td class="p-4">
                <div class="flex items-center space-x-3">
                  <div
                  ...
                  <div>
                    ...
                    <p v-if="category.code" class="text-xs text-neutral-500">
                      Code: {{ category.code }}
                    </p>
                    <p v-if="getParentCategoryName(category.parentId)" class="text-xs text-brand-600">
              ...
              <td class="p-4">
                <div class="flex items-center">
                  <CubeIcon class="w-4 h-4 text-neutral-400 mr-1" />
                  <span class="text-sm font-medium text-neutral-900">{{ category.itemCount }}</span>
                </div>
              </td>
              <td class="p-4">
                  <span
        ...
        <div class="bg-white rounded-2xl shadow-soft-lg w-full max-w-4xl max-h-[90vh] overflow-y-auto">
          ...
          <form @submit.prevent="saveCategory" class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <label class="block text-sm font-semibold text-neutral-700 mb-2">Category Code</label>
                <input
                  v-model="form.code"
                  type="text"
              ...
              <div>
                <label class="block text-sm font-semibold text-neutral-700 mb-2">Parent Category</label>
                <select
              ...
              <div>
                <label class="block text-sm font-semibold text-neutral-700 mb-2">Sort Order</label>
                <input
              ...
              <div>
                <label class="block text-sm font-semibold text-neutral-700 mb-2">Tax Category</label>
                <select
              ...
              <div class="md:col-span-2">
                <label class="block text-sm font-semibold text-neutral-700 mb-2">Image URL</label>
                <input
        ...
        <div class="bg-white rounded-2xl shadow-soft-lg w-full max-w-md">
          <div class="p-6">
            <div class="flex items-center mb-4">
              ...
              <h3 class="text-lg font-bold text-neutral-900">Delete Category</h3>
            </div>
